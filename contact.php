  ...
  <div class="row">  <!--Start Contact Us Row-->
    <div class="col-md-8"> <!--Start Contact Us 1st Column-->
      <form action="" method="post">
        ...
        <textarea class="form-control" name="message" placeholder="How can we help you?" style="height:150px; resize: none;"></textarea><br>
    ...
    <div class="col-md-4 stripe text-white text-center">  <!-- Start Contact Us 2nd Column-->
      ...
      <p>Edu Quest Tower, Mohammadpur, Dhaka, Bangladesh - 1216<br /> 
      Phone: +8801747687342 <br />
